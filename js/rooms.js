 ...
 * Blast Chiller Condensing Units) has roomKey "roof" and is intentionally NOT
 * drawn here — it isn't part of this interior floor plan. It gets its own
 * card grid in the Roof Level tab, plus a compact "Rooftop Snapshot" status
 * tile overlaid in this map's corner (see renderRooftopSnapshot in js/app.js)
 * that jumps to that tab on click.
 */
