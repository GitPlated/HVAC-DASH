...
// either).
// Goodyear's real RT/Lead Tech roster (onboarding.html Section 04), per
// Jacob (2026-09-08). Employee numbers were given alongside these names
// for whoever administers access, not tracked here -- this app attributes
// by name only, same as Aurora's, no employee-ID field anywhere in the
// data model. RTs and Lead Techs get identical edit access -- canEdit()
// below doesn't distinguish by role, only Admin (view-only) is different.
const IDENTITY_OPTIONS = [
  // RTs
  { id: "israel", name: "Israel Araujo", themeClass: "identity-theme-israel" },
  { id: "damarys", name: "Damarys Lopez", themeClass: "identity-theme-damarys" },
  // Lead Techs
  { id: "ferrell", name: "Ferrell Slowtalker", themeClass: "identity-theme-ferrell" },
  { id: "cliff", name: "Cliff Robinson", themeClass: "identity-theme-cliff" },
  { id: "hasanain", name: "Hasanain Murad", themeClass: "identity-theme-hasanain" },
  { id: "jess", name: "Jess Meeder", themeClass: "identity-theme-jess" },
  { id: "anthony", name: "Anthony Morgan", themeClass: "identity-theme-anthony" },
  { id: "richard", name: "Richard Iniguez", themeClass: "identity-theme-richard" },
...
// Aurora's list (hartwig/nesco/nesko/ams) doesn't apply here -- Goodyear's
// own outside refrigeration vendors haven't been gathered yet. The
// explicit "Outsourced to a vendor" checkbox on the update form still
// works fully without this; it's only a fallback for someone mentioning
// a vendor by name in free-text notes instead of checking the box.
